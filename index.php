...
<head>
    ...
    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        ...
        })(window,document,'script','dataLayer','GTM-N7KXVP5');</script>
...
<header style="animation-name:fadeInDown">
            ...
            <svg fill="none" height="88" viewBox="0 0 227 88" width="227" xmlns="http://www.w3.org/2000/svg">
                ...
                <g>
                    ...
                    <text fill="#000000" font-family="'Trebuchet MS', Gadget, sans-serif" font-size="24"
                          ...
                          x="220" xml:space="preserve" y="26">БЕТА</text>
                </g>
            </svg>
        </a>
    </div>
    <nav>
        <ul class="headerMenu">
            ...
            <li class="menu-item"><a href="">Программирование</a></li>
...
<footer>
    <div class="footerNav block">
        ...
        <div class="footerMenu">
            ...
            <ul class="socialMenu">
                <li><a class="teleg" href=""><i class="fab fa-telegram-plane"></i></a></li>
